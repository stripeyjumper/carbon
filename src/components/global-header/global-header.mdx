...
<Canvas name="default" of={GlobalHeaderStories.Default} />
...
<Canvas name="with logo" of={GlobalHeaderStories.WithLogo} />
...
<Canvas name="basic menu" of={GlobalHeaderStories.BasicMenu} />
...
<Canvas name="responsive menu" of={GlobalHeaderStories.ResponsiveMenu} />
...
<Canvas
  ...
  of={GlobalHeaderStories.GlobalLocalNavBarLayout}
/>
