...
<Canvas name="default" of={LinkPreviewStories.DefaultStory} />
...
<Canvas name="with loading state" of={LinkPreviewStories.LinkPreviewLoadingState} />
...
<Canvas name="with close icon" of={LinkPreviewStories.LinkPreviewCloseIcon} />
