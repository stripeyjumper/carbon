...
<Canvas name="default" of={DialogStories.DefaultStory} />
...
<Canvas name="editable" of={DialogStories.Editable} />

### With help

<Canvas name="with help" of={DialogStories.WithHelp} />
...
<Canvas
  ...
  of={DialogStories.FocusingADifferentFirstElement}
/>
...
<Canvas name="loading content" of={DialogStories.LoadingContent} />
...
<Canvas
  ...
  of={DialogStories.OverridingContentPadding}
/>
...
<Canvas
  ...
  of={DialogStories.OtherFocusableContainers}
/>

### Responsive Example

<Canvas name="responsive" of={DialogStories.Responsive} />
