...
<Canvas name="default" of={SimpleColorPickerStories.Default} />

### Disabled

<Canvas name="disabled" of={SimpleColorPickerStories.Disabled} />

### Required

You can use the `required` prop to indicate if the field is mandatory.

<Canvas name="required" of={SimpleColorPickerStories.Required} />

#### With margin

<Canvas name="with margin" of={SimpleColorPickerStories.WithMargin} />
