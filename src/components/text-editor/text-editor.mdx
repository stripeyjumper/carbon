...
<Canvas name="default" of={TextEditorStories.Default} />
...
<Canvas name="with content" of={TextEditorStories.WithContent} />
...
<Canvas
  name="with optional buttons"
  of={TextEditorStories.WithOptionalButtons}
/>
...
<Canvas
  ...
  of={TextEditorStories.WithOptionalCharacterLimit}
/>
...
<Canvas name="with validation" of={TextEditorStories.WithValidation} />
...
<Canvas
  ...
  of={TextEditorStories.WithMultilineValidation}
/>

<Canvas name="with new validation" of={TextEditorStories.WithNewValidation} />
...
<Canvas
  ...
  of={TextEditorStories.WithCustomRowHeight}
/>
...
<Canvas name="with link previews" of={TextEditorStories.WithLinkPreviews} />

## Props

### Text Editor

<ArgTypes of={TextEditorStories} margin noHeader />
