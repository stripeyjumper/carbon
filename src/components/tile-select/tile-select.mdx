...
<Canvas name="default" of={TileSelectStories.Default} />
...
<Canvas
  ...
  of={TileSelectStories.WithCustomActionButton}
/>
...
<Canvas
  ...
  of={TileSelectStories.WithActionButtonAdornment}
/>
...
<Canvas name="multi Select" of={TileSelectStories.MultiSelect} />
...
<Canvas name="single tile" of={TileSelectStories.SingleTile} />

### With a footer

To render a `footer` pass anything renderable to the prop like in the example below.

<Canvas name="with a footer" of={TileSelectStories.WithAFooter} />
...
<Canvas
  name="with a prefix adornment"
  of={TileSelectStories.WithAPrefixAdornment}
/>
...
<Canvas
  ...
  of={TileSelectStories.WithAdditionalInformation}
/>
...
<Canvas
  name="with accordion footer"
  of={TileSelectStories.WithAccordionFooter}
/>
...
<Canvas name="with custom spacing" of={TileSelectStories.WithCustomSpacing} />
