...
<Canvas name="default" of={DateRangeStories.DefaultStory} />

### LabelsInline

<Canvas name="labelsInline" of={DateRangeStories.LabelsInline} />
...
<Canvas
  ...
  of={DateRangeStories.ValidationsStringComponent}
/>
...
<Canvas
  ...
  of={DateRangeStories.ValidationsStringLabel}
/>
...
<Canvas
  ...
  of={DateRangeStories.ValidationsStringNewDesign}
/>

#### As a boolean

<Canvas name="validations - boolean" of={DateRangeStories.ValidationsBoolean} />

### Allow Empty Value

You can pass prop `allowEmptyValue` to start and end `DateInput` using `startDateProps` and `endDateProps`.

<Canvas name="allowEmptyValue" of={DateRangeStories.AllowEmptyValue} />
...
<Canvas
  ...
  of={DateRangeStories.LocaleOverrideExampleImplementation}
/>
