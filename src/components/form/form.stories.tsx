...
WithBothErrorsAndWarningsSummary.storyName = "With Both Errors and Warnings Summary";
...
InDialogFullScreenWithStickyFooter.storyName = "In Dialog Full Screen with Sticky Footer";
