...
<Canvas
  ...
  of={FormStories.DefaultWithStickyFooter}
/>

### Full Width Buttons

<Canvas name="with full width buttons" of={FormStories.WithFullWidthButtons} />
...
<Canvas name="with different spacing" of={FormStories.WithDifferentSpacing} />
...
<Canvas name="override field spacing" of={FormStories.OverrideFieldSpacing} />
...
<Canvas name="with errors summary" of={FormStories.WithErrorsSummary} />

<Canvas name="with warnings summary" of={FormStories.WithWarningsSummary} />

<Canvas
  name="with both errors and warnings summary"
  of={FormStories.WithBothErrorsAndWarningsSummary}
/>
...
<Canvas name="with additional buttons" of={FormStories.WithAdditionalButtons} />

When `buttonAlignment` prop is set as `left`, buttons are aligned to the left side.

<Canvas
  name="with buttons aligned to the left"
  of={FormStories.WithButtonsAlignedToTheLeft}
/>
...
<Canvas name="in Dialog" of={FormStories.InDialog} />

#### With sticky footer

<Canvas
  name="in Dialog with sticky footer"
  of={FormStories.InDialogWithStickyFooter}
/>
...
<Canvas name="in DialogFullScreen" of={FormStories.InDialogFullScreen} />

#### With sticky footer

<Canvas
  name="in DialogFullScreen with sticky footer"
  of={FormStories.InDialogFullScreenWithStickyFooter}
/>
...
<Canvas name="form alignment example" of={FormStories.FormAlignmentExample} />

### With labels inline

<Canvas name="with labels inline" of={FormStories.WithLabelsInline} />

### With custom footer padding

<Canvas name="custom footer padding" of={FormStories.WithCustomFooterPadding} />
