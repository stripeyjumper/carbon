...
import DeprecationWarning from "../../../../../.storybook/deprecationWarning";
...
<Canvas name="default" of={CarouselStories.Default} />

### Without buttons

<Canvas name="without buttons" of={CarouselStories.WithoutButtons} />

### Without slideSelectors

<Canvas
  name="without slideSelectors"
  of={CarouselStories.WithoutSlideSelectors}
/>
