...
<Canvas name="default" of={ContentStories.DefaultStory} />

### Inline content

<Canvas name="inline" of={ContentStories.InlineContent} />

### Custom title

<Canvas name="custom title" of={ContentStories.CustomTitle} />

### Secondary styling

<Canvas name="secondary styling" of={ContentStories.SecondaryStyling} />
