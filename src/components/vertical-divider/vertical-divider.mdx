...
<Canvas name="default" of={VerticalDividerStories.Default} />
...
<Canvas name="in a flex container" of={VerticalDividerStories.InAFlexContainer} />
...
<Canvas name="in a non-flex container" of={VerticalDividerStories.InANonFlexContainer} />
...
<Canvas
  name="with custom spacing and height"
  of={VerticalDividerStories.WithCustomSpacingHeight}
/>
...
<Canvas name="with custom tint" of={VerticalDividerStories.WithCustomTint} />

### In a Dialog

<Canvas name="in a dialog" of={VerticalDividerStories.InADialog} />

### In a Tile

<Canvas name="in a tile" of={VerticalDividerStories.InATile} />

### In a grid container

This example is best viewed in the Canvas tab using full-screen mode with device or viewport emulation.

<Canvas name="in grid container" of={VerticalDividerStories.InGridContainer} />

### In a table

<Canvas name="in a table" of={VerticalDividerStories.InATable} />

### In a Menu

<Canvas name="in a menu" of={VerticalDividerStories.InAMenu} />
