...
test.describe("Prop tests for Menu component", () => {
  ...
  test(`should verify a the first submenu item is focused using keyboard tabbing after the parent item was clicked`, async ({
    mount,
    page,
  }) => {
    await mount(<MenuComponent />);
  ...
  test(`should verify a the first submenu item is focused using keyboard down arrow after the parent item was clicked`, async ({
    mount,
    page,
  }) => {
    await mount(<MenuComponent />);
  ...
  ([
    ...
    test(`should verify icons have the correct color when menuType is ${menuType}`, async ({
      mount,
      page,
    }) => {
      await mount(
  ...
  test(`should verify Menu Segment Title is visible within a submenu`, async ({
    mount,
    page,
  }) => {
    await mount(<MenuComponent />);
  ...
  test(`should verify default menu clickToOpen element does not open on hover`, async ({
    mount,
    page,
  }) => {
  ...
  test(`should verify default menu clickToOpen element opens on click`, async ({
    mount,
    page,
  }) => {
  ...
  ["Enter", "Space", "ArrowDown", "ArrowUp"].forEach((key) => {
    test(`should verify default menu clickToOpen element opens using ${key} key`, async ({
      mount,
      page,
    }) => {
      await mount(<MenuItems clickToOpen />);
  ...
  test(`should not close submenu when enter is pressed on search component`, async ({
    mount,
    page,
  }) => {
    await mount(<MenuComponentSearch />);
  ...
  ["block", "inline-block", "flex", "contents", "list-item", "none"].forEach(
    (display) => {
      test(`should verify Menu display is ${display}`, async ({
        mount,
        page,
      }) => {
  ...
  [
    ...
    test(`should verify Menu verticalAlign is ${alignment}`, async ({
      mount,
      page,
    }) => {
  ...
  ["auto", "clip", "hidden", "scroll", "visible"].forEach((overflow) => {
    test(`should verify Menu overflow is ${overflow}`, async ({
      mount,
      page,
    }) => {
  ...
  ([
    ...
    test(`should verify Menu overflowX is ${overflow}`, async ({
      mount,
      page,
    }) => {
      ...
      const thisMenu = menu(page).first();
      await expect(thisMenu).toHaveCSS("overflow-x", overflow!.toString());
    });
  });
  ...
  ([
    ...
    test(`should verify Menu overflowY is ${overflow}`, async ({
      mount,
      page,
    }) => {
      ...
      const thisMenu = menu(page).first();
      await expect(thisMenu).toHaveCSS("overflow-y", overflow!.toString());
    });
  });

  ["normal", "stretch", "baseline", "center", "flex-start", "flex-end"].forEach(
    (alignment) => {
      test(`should verify Menu alignItems is ${alignment}`, async ({
        mount,
        page,
      }) => {
  ...
  [
    ...
    test(`should verify Menu alignContent is ${alignment}`, async ({
      mount,
      page,
    }) => {
  ...
  [
    ...
    test(`should verify Menu justifyItems is ${justified}`, async ({
      mount,
      page,
    }) => {
  ...
  [
    ...
    test(`should verify Menu justifyContent is ${justified}`, async ({
      mount,
      page,
    }) => {
  ...
  (["nowrap", "wrap", "wrap-reverse"] as MenuProps["flexWrap"][]).forEach(
    (wrap) => {
      test(`should verify Menu flex wrap is ${wrap}`, async ({
        mount,
        page,
      }) => {
        ...
        const thisMenu = menu(page).first();
        await expect(thisMenu).toHaveCSS("flex-wrap", wrap!.toString());
      });
    }
  );
  ...
  ([
    ...
    test(`should verify Menu flex direction is ${direction}`, async ({
      mount,
      page,
    }) => {
      ...
      const thisMenu = menu(page).first();
      await expect(thisMenu).toHaveCSS("flex-direction", direction!.toString());
    });
  });

  ["auto", "content", "fit-content", "max-content", "min-content"].forEach(
    (flex) => {
      test(`should verify Menu flex is ${flex}`, async ({ mount, page }) => {
  ...
  ([
    ...
    test(`should verify Menu flex grow is ${value}`, async ({
      mount,
      page,
    }) => {
  ...
  ([
    ...
    test(`should verify Menu flex shrink is ${value}`, async ({
      mount,
      page,
    }) => {
  ...
  ["auto", "content", "fit-content", "max-content", "min-content"].forEach(
    (basis) => {
      test(`should verify Menu flex basis is ${basis}`, async ({
        mount,
        page,
      }) => {
  ...
  [
    ...
    test(`should verify Menu justifySelf is ${justify}`, async ({
      mount,
      page,
    }) => {
  ...
  [
    ...
    test(`should verify Menu alignSelf is ${align}`, async ({
      mount,
      page,
    }) => {
  ...
  ([
    ...
    test(`should verify Menu order is ${value}`, async ({ mount, page }) => {
  ...
  test(`should verify Menu Items className is customisable`, async ({
    mount,
    page,
  }) => {
  ...
  ([
    ...
    ([state, boolVal, color]) => {
      test(`should verify first Menu Item is ${state}`, async ({
        mount,
        page,
      }) => {
  ...
  [
    ...
    test(`should verify Menu Item text is ${text}`, async ({ mount, page }) => {
  ...
  test(`should verify Menu Item target is ${CHARACTERS.STANDARD}`, async ({
    mount,
    page,
  }) => {
  ...
  ([
    ...
    test(`should verify Menu Item has ${variant} variant`, async ({
      mount,
      page,
    }) => {
  ...
  test(`should verify Menu Item ariaLabel is set to cypress_data`, async ({
    mount,
    page,
  }) => {
  ...
  ([
    ...
    ([size, height, margin, width]) => {
      test(`should verify that a Menu size is ${size}`, async ({
        mount,
        page,
      }) => {
        await mount(
  ...
  ([
    ...
    ([variant, color]) => {
      test(`should verify Menu scroll block has ${variant} background color using variant prop`, async ({
        mount,
        page,
      }) => {
  ...
  test(`should verify Menu Item href prop`, async ({ mount, page }) => {
  ...
  ([["noopener"], ["noreferrer"], ["opener"]] as [
    ...
    test(`should verify Menu Item with rel prop set to ${rel}`, async ({
      mount,
      page,
    }) => {
      ...
      const subMenu = submenu(page).first().locator("button");
      await expect(subMenu).toHaveAttribute("rel", rel!.toString());
    });
  });
...
test.describe("Prop tests for Menu Fullscreen component", () => {
  test(`should verify that the Menu Fullscreen is rendered properly`, async ({
    mount,
    page,
  }) => {
    await page.setViewportSize({ width: 1200, height: 800 });
  ...
  test(`should verify that close icon is focused in Menu Fullscreen, focusRedesignOptOut false`, async ({
    mount,
    page,
  }) => {
    await page.setViewportSize({ width: 1200, height: 800 });
  ...
  test(`should verify that close icon is focused in Menu Fullscreen, focusRedesignOptOut true`, async ({
    mount,
    page,
  }) => {
    await page.setViewportSize({ width: 1200, height: 800 });
  ...
  ([
    ...
    ([value, boolVal]) => {
      test(`should verify that Menu Fullscreen is ${value} when isOpen prop is ${boolVal}`, async ({
        mount,
        page,
      }) => {
        await page.setViewportSize({ width: 1200, height: 800 });
  ...
  ([
    ...
    ([side, left, right]) => {
      test(`should verify that Menu Fullscreen start position is ${side}`, async ({
        mount,
        page,
      }) => {
        await page.setViewportSize({ width: 1200, height: 800 });
...
test.describe("Accessibility tests for Menu component", () => {
  test(`should pass accessibility tests for Menu default`, async ({
    mount,
    page,
  }) => {
    await mount(<MenuComponent />);
  ...
  test(`should pass accessibility tests for Menu expanded`, async ({
    mount,
    page,
  }) => {
    await mount(<MenuComponent />);
...
test.describe("Accessibility tests for Menu Fullscreen component", () => {
  ...
  test(`should pass accessibility tests for Menu Fullscreen when close icon is clicked`, async ({
    mount,
    page,
  }) => {
    await page.setViewportSize({ width: 1200, height: 800 });
  ...
  test(`should pass accessibility tests for Menu Fullscreen when menu item is highlighted`, async ({
    mount,
    page,
  }) => {
    await page.setViewportSize({ width: 1200, height: 800 });
  ...
  (["left", "right"] as MenuFullscreenProps["startPosition"][]).forEach(
    (side) => {
      test(`should pass accessibility tests for Menu Fullscreen when start position is ${side}`, async ({
        mount,
        page,
      }) => {
        await page.setViewportSize({ width: 1200, height: 800 });
...
test.describe(
  ...
  () => {
    test(`menu items should have the expected focus styling, focusRedesignOptOut true`, async ({
      mount,
      page,
    }) => {
      await page.setViewportSize({ width: 1200, height: 800 });
    ...
    test(`menu items should have the expected focus styling, focusRedesignOptOut false`, async ({
      mount,
      page,
    }) => {
      await page.setViewportSize({ width: 1200, height: 800 });
    ...
    test(`has the expected border radius styling on the Submenu`, async ({
      mount,
      page,
    }) => {
      await mount(<MenuComponent />);
    ...
    test(`has the expected border radius styling on the Submenu Scrollable Block`, async ({
      mount,
      page,
    }) => {
      await mount(<MenuComponentScrollable />);
    ...
    test(`all the content of a long submenu can be accessed with the keyboard while remaining visible`, async ({
      mount,
      page,
    }) => {
    ...
    test(`all the content of a long submenu can be accessed with the keyboard while remaining visible if the navbar height changes`, async ({
      mount,
      page,
    }) => {
