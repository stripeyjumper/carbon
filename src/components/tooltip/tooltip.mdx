...
<Canvas name="default" of={TooltipStories.Default} />

### Controlled

The Tooltip can also be controlled via the `isVisible` prop.

<Canvas name="controlled" of={TooltipStories.Controlled} />
...
<Canvas name="positioning" of={TooltipStories.Positioning} />
...
<Canvas
  name="flip behaviour overrides"
  of={TooltipStories.FlipBehaviourOverrides}
/>

### Large tooltip

<Canvas name="large tooltip" of={TooltipStories.LargeTooltip} />
...
<Canvas name="types" of={TooltipStories.Types} />
...
<Canvas name="color overrides" of={TooltipStories.ColorOverrides} />
