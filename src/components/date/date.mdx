...
<Canvas name="default" of={DateStories.Default} />

### Sizes

<Canvas name="sizes" of={DateStories.Sizes} />

### AutoFocus

<Canvas name="autoFocus" of={DateStories.AutoFocus} />

### Disabled

<Canvas name="disabled" of={DateStories.Disabled} />

### ReadOnly

<Canvas name="readOnly" of={DateStories.ReadOnly} />

### Empty

<Canvas name="empty" of={DateStories.Empty} />

### With labelInline

<Canvas name="with labelInline" of={DateStories.WithLabelInline} />

### With custom width

<Canvas name="with custom width" of={DateStories.WithCustomWidth} />

### With fieldHelp

<Canvas name="with fieldHelp" of={DateStories.WithFieldHelp} />

### With labelHelp

<Canvas name="with labelHelp" of={DateStories.WithLabelHelp} />

### With disabled portal

<Canvas name="with disabled portal" of={DateStories.WithDisabledPortal} />

### Required

You can use the `required` prop to indicate if the field is mandatory.

<Canvas name="required" of={DateStories.Required} />
...
<Canvas
  ...
  of={DateStories.ValidationsStringComponent}
/>
...
<Canvas
  ...
  of={DateStories.ValidationsStringLabel}
/>
...
<Canvas
  ...
  of={DateStories.ValidationsStringWithTooltipPositionOverriddenLabel}
/>
...
<Canvas
  ...
  of={DateStories.ValidationsStringNewDesign}
/>

#### As a boolean

<Canvas name="validations - boolean" of={DateStories.ValidationsBoolean} />
...
<Canvas
  ...
  of={DateStories.ValidationsExampleImplementation}
/>
...
<Canvas
  ...
  of={DateStories.LocaleOverrideExampleImplementation}
/>
