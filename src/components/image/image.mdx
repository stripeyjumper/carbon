...
<Canvas name="default" of={ImageStories.DefaultStory} />
...
<Canvas name="as an img" of={ImageStories.AsAnImg} />
...
<Canvas name="with hidden prop" of={ImageStories.WithHiddenProp} />
...
<Canvas name="decorative" of={ImageStories.DecorativeStory} />
...
<Canvas name="custom responsive behaviour"
    of={ImageStories.CustomResponsiveBehaviour}
  />
