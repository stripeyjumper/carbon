...
ValidationString.storyName = "Single Switch - String Validation";
ValidationString.args = { validation: "Message" };

export const ValidationStringTooltip = Validation.bind({});
ValidationStringTooltip.storyName =
  "Single Switch - String Validation - Tooltip Position Overriden";
...
ValidationStringLabel.storyName =
  "Single Switch - String Validation - validationOnLabel";
...
ValidationStringLabelTooltip.storyName =
...
ValidationBoolean.storyName = "Single Switch - Boolean Validation";
