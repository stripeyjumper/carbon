...
<Canvas name="default" of={ProgressTrackerStories.Default} />

### Small bar size

This is an example of a small `ProgressTracker` component.

<Canvas name="size - small" of={ProgressTrackerStories.SizeSmall} />

### Large bar size

This is an example of a large `ProgressTracker` component.

<Canvas name="size - large" of={ProgressTrackerStories.SizeLarge} />
...
<Canvas name="custom bar length" of={ProgressTrackerStories.CustomBarLength} />

### Color variants

This is an example of a `ProgressTracker` component with different colors depending on progress.

<Canvas name="color variants" of={ProgressTrackerStories.ColorVariants} />
...
<Canvas
  ...
  of={ProgressTrackerStories.DefaultLabelValue}
/>

It is possible to override the default `labelsPosition` to `"bottom"`

<Canvas
  name="default label value - labelsPosition bottom"
  of={ProgressTrackerStories.DefaultLabelValueLabelsPositionBottom}
/>
...
<Canvas
  name="custom label values"
  of={ProgressTrackerStories.CustomLabelValues}
/>
...
<Canvas
  name="default and custom label values"
  of={ProgressTrackerStories.DefaultAndCustomLabelValues}
/>
...
<Canvas
  name="acessibility example"
  of={ProgressTrackerStories.AccessibilityExample}
/>
...
<Canvas
  name="acessibility example 2"
  of={ProgressTrackerStories.AccessibilityExampleTwo}
/>
