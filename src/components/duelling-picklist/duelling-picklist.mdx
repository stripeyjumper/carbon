...
<Canvas name="default" of={Default} />
...
<Canvas name="grouped" of={DuellingPicklistStories.Grouped} />

### In Dialog

Same as above but as a children of `Dialog` component.

<Canvas name="in dialog" of={DuellingPicklistStories.InDialog} />

## PicklistItem Examples

### Add item

<Canvas name="add item" of={DuellingPicklistStories.AddItem} />

### Remove item

<Canvas name="remove item" of={DuellingPicklistStories.RemoveItem} />

### Locked

<Canvas name="locked" of={DuellingPicklistStories.Locked} />

### Custom tooltip message

<Canvas name="custom tooltip message" of={DuellingPicklistStories.CustomTooltipMessage} />
