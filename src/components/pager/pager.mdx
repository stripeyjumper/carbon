...
<Canvas name="disabled page size" of={PagerStories.DisabledPageSize} />
...
<Canvas name="hiding pager elements" of={PagerStories.HidingPagerElements} />
...
<Canvas name="smart functionality" of={PagerStories.SmartFunctionality} />

### Loading state

When no totalRecords provided.

<Canvas name="loading state" of={PagerStories.LoadingState} />
...
<Canvas
  ...
  of={PagerStories.PageSizeSelectionOptions}
/>
...
<Canvas name="current page last page" of={PagerStories.CurrentPageLastPage} />

### With currentPage pre-set to page 5

<Canvas name="current page" of={PagerStories.CurrentPage} />
...
<Canvas
  ...
  of={PagerStories.UsingCustomResponsiveSettings}
/>
