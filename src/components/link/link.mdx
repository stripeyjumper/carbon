...
To use Link with a routing library see our documentation on this here: <LinkTo href="https://carbon.sage.com/?path=/docs/documentation-usage-with-routing--page"
    target="_blank"
    rel="noreferrer noopener">Usage with routing</LinkTo>
...
<Canvas name="default" of={LinkStories.DefaultStory} />
...
<Canvas name="with disabled" of={LinkStories.WithDisabled} />

### Icon

The `icon` prop allows you to render an icon.

<Canvas name="with icon" of={LinkStories.WithIcon} />
...
<Canvas name="with iconAlign" of={LinkStories.WithIconAlign} />
...
<Canvas name="with tooltip" of={LinkStories.WithTooltip} />
...
<Canvas name="with isSkipLink" of={LinkStories.WithIsSkipLink} />
...
<Canvas name="on a dark background" of={LinkStories.OnADarkBackground} />

### Link that wraps

Just as with a native HTML anchor element, `Link` components will wrap onto the next line if they contain long text.

<Canvas name="link that wraps" of={LinkStories.Wrapping} />
