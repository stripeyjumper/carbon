...
<Canvas name="default" of={SidebarStories.DefaultStory} />

### Custom padding around content

<Canvas
  name="custom padding around content"
  of={SidebarStories.CustomPaddingAroundContent}
/>

### With header

<Canvas name="with header" of={SidebarStories.WithHeader} />

### With scroll

If sidebar content does not fit the sidebar, scroll will appear. Default scroll theme is "light".

<Canvas name="with scroll" of={SidebarStories.WithScroll} />

### With Typography

<Canvas name="with typography" of={SidebarStories.WithTypography} />
...
<Canvas
  ...
  of={SidebarStories.OtherFocusableContainers}
/>
...
<Canvas name="custom width" of={SidebarStories.CustomWidth} />

### With header and footer padding overridden

<Canvas
  name="with header and footer padding"
  of={SidebarStories.WithHeaderAndFooterPadding}
/>
