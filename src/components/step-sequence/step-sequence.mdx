...
<Canvas name="default" of={StepSequenceStories.DefaultStory} />

### Vertical

<Canvas name="vertical" of={StepSequenceStories.Vertical} />

### With hidden indicators

<Canvas
  name="with hidden indicators"
  of={StepSequenceStories.WithHiddenIndicators}
/>

### Responsive Example

<Canvas name="responsive" of={StepSequenceStories.ResponsiveExample} />
