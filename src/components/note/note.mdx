...
<Meta title="Note" parameters={{ info: { disable: true } }} of={NoteStories} />
...
<Canvas name="default" of={NoteStories.Default} />
...
<Canvas name="with rich text" of={NoteStories.WithRichText} />

### With title

An optional title can be provided using the `title` prop.

<Canvas name="with title" of={NoteStories.WithTitle} />
...
<Canvas name="with inline controls" of={NoteStories.WithInlineControls} />

### With status

An optional status can be provided using the `status` prop.

<Canvas name="with status" of={NoteStories.WithStatus} />
...
<Canvas name="with previews" of={NoteStories.WithPreviews} />
...
<Canvas name="with margin" of={NoteStories.WithMargin} />
