...
<Meta title="Tabs" parameters={{ info: { disable: true } }} of={TabsStories} />
...
<Canvas name="default" of={TabsStories.DefaultStory} />

### Positioned top and aligned right

<Canvas
  name="positioned top aligned right"
  of={TabsStories.PositionedTopAlignedRight}
/>
...
<Canvas
  ...
  of={TabsStories.PositionedLeftAndAlignedLeft}
/>
...
<Canvas
  ...
  of={TabsStories.PositionedLeftAndAlignedRight}
/>
...
<Canvas name="with link as a tab" of={TabsStories.WithLinkAsATab} />
...
<Canvas
  ...
  of={TabsStories.WithSpecifiedTabVisible}
/>
...
<Canvas
  ...
  of={TabsStories.WithoutExtendedDividingLine}
/>
...
<Canvas
  ...
  of={TabsStories.WithLargeTabsPositionedTop}
/>
...
<Canvas
  ...
  of={TabsStories.WithLargeTabsPositionedLeft}
/>
...
<Canvas
  ...
  of={TabsStories.WithBordersPositionedTop}
/>
...
<Canvas
  ...
  of={TabsStories.WithNoSidesPositionedTop}
/>
...
<Canvas
  ...
  of={TabsStories.WithBordersPositionedLeft}
/>
...
<Canvas
  ...
  of={TabsStories.WithNoSidesPositionedLeft}
/>
...
<Canvas
  ...
  of={TabsStories.WithValidationsPositionedTop}
/>

<Canvas
  name="with validations sized large positioned top"
  of={TabsStories.WithValidationsSizedLargePositionedTop}
/>

<Canvas
  name="with validations positioned left"
  of={TabsStories.WithValidationsPositionedLeft}
/>

<Canvas
  name="with validations sized large positioned left"
  of={TabsStories.WithValidationsSizedLargePositionedLeft}
/>
...
<Canvas
  ...
  of={TabsStories.WithAdditionalTitleSiblings}
/>

<Canvas
  name="with additional title siblings size large"
  of={TabsStories.WithAdditionalTitleSiblingsSizeLarge}
/>
...
<Canvas name="with custom layout" of={TabsStories.WithCustomLayout} />
...
<Canvas name="with alternate styling" of={TabsStories.WithAlternateStyling} />

### With headerWidth

The `headerWidth` prop works only if prop `position` is set to `left`.

<Canvas name="with headerWidth" of={TabsStories.WithHeaderWidth} />
...
<Canvas name="with custom spacing" of={TabsStories.WithCustomSpacing} />
...
<Canvas name="responsive" of={TabsStories.Responsive} />
...
<Canvas
  ...
  of={TabsStories.WithStringValidationsSummarised}
/>
