...
<Canvas name="default" of={ProfileStories.Default} />
...
<Canvas name="dark background" story={ProfileStories.DarkBackground} />

### Src

To use an image, simply pass any valid image URL as a `src` prop.

<Canvas name="src" of={ProfileStories.Src} />

### Sizes

<Canvas name="sizes" of={ProfileStories.Sizes} />

### Responsive Example

<Canvas name="responsive" of={ProfileStories.Responsive} />
