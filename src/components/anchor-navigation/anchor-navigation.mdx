...
<Canvas name="default" of={AnchorNavigationStories.DefaultStory} />

### In DialogFullScreen

`AnchorNavigation` can also be used as the content of `DialogFullScreen` component.

<Canvas name="in full screen dialog" of={AnchorNavigationStories.InFullScreenDialogStory} />
...
<ArgTypes of={AnchorNavigationItem} />
